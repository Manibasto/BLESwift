...
//            let str =  imageData.base64EncodedString(options: Data.Base64EncodingOptions.lineLength64Characters)
//            dataToSend = currentTextSnapshot.data(using: String.Encoding.utf8)
...
//            let chunk = dataToSend.subdata(in: sendDataIndex ..< upToIndex)
            ...
            print("Next Chunk from data: \(chunkText ?? "Could Not Chunk")")
            ...
            if sendDataIndex >= dataToSend.count {
               ...
               // let eomData = Device.EOM.data(using: Data.utf8)!

               // let image : UIImage = UIImage(data: sendDataIndex)
